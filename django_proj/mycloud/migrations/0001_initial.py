# Generated by Django 6.0.7 on 2026-07-23 08:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.FileField(upload_to=mycloud.models.user_storage_path)),
                ('original_name', models.CharField(max_length=255)),
                ('size', models.BigIntegerField(default=0)),
                ('comment', models.TextField(blank=True, default='')),
                ('upload_date', models.DateTimeField(auto_now_add=True)),
                ('last_download_date', models.DateTimeField(blank=True, null=True)),
                ('download_link', models.CharField(blank=True, max_length=255, unique=True)),
